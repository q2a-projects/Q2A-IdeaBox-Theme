...
*/
	...
	return array(
		...
		'feed_a_edited_prefix' => 'Response edited: ',
		'feed_a_prefix' => 'Responseed: ',
		'feed_a_reshown_prefix' => 'Response reshown: ',
		'feed_a_selected_prefix' => 'Response selected: ',
		...
		'nav_user_as' => 'All responses',
		'nav_user_qs' => 'All suggestions',
		'nav_user_wall' => 'Wall',
		'no_activity_from_x' => 'No activity from ^',
		'no_favorite_categories' => 'No favorite categories',
		'no_favorite_qs' => 'No favorite suggestions',
		...
		'suggest_favorites_add' => 'To add a suggestion or other item to your favorites, click the ^ at the top of its page.',
		'suggest_update_favorites' => 'For more updates, add items to ^1your favorites^2.',
		'unblock_ip_button' => 'Unblock IP address',
		'your_a_commented' => 'your response commented',
		'your_a_edited' => 'your response edited',
		'your_a_hidden' => 'your response hidden',
		'your_a_suggestioned' => 'posted on your response',
		'your_a_reshown' => 'your response reshown',
		'your_a_selected' => 'your response selected',
		...
		'your_q_responseed' => 'your suggestion responseed',
		'your_q_closed' => 'your suggestion closed',
		'your_q_commented' => 'your suggestion commented',
		'your_q_edited' => 'your suggestion edited',
		'your_q_hidden' => 'your suggestion hidden',
		'your_q_recategorized' => 'your suggestion recategorized',
		'your_q_reopened' => 'your suggestion reopened',
		'your_q_reshown' => 'your suggestion reshown',
		'your_q_retagged' => 'your suggestion retagged',
	);
