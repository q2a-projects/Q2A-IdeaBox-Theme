...
*/
	...
	return array(
		...
		'allow_close_suggestions' => 'Allow suggestions to be manually closed:',
		'allow_login_email_only' => 'Only log in by email address (not username):', 
		'allow_multi_responses' => 'Allow multiple responses per user:',
		'allow_no_category' => 'Allow suggestions with no category',
		'allow_no_sub_category' => 'Allow suggestions with a category but no sub-category',
		'allow_private_messages' => 'Enable private messaging between users:',
		'allow_user_walls' => 'Enable wall posts on user profiles:',
		'allow_self_response' => 'Allow users to response their own suggestion:',
		'allow_view_q_bots' => 'Allow search engines to view suggestion pages',
		...
		'avatar_q_list_size' => 'Avatar size on suggestion lists:',
		'avatar_q_page_a_size' => 'Avatar size on responses:',
		'avatar_q_page_c_size' => 'Avatar size on comments:',
		'avatar_q_page_q_size' => 'Avatar size on suggestions:',
		...
		'comment_on_as' => 'Allow comments on responses:',
		'comment_on_qs' => 'Allow comments on suggestions:',
		...
		'default_sidebar' => "Welcome to ^, where you can post suggestions and receive responses from other members of the community.",
		'default_subject' => 'A message from ^',
		'default_suffix' => 'Q&A',
		'do_ask_check_qs' => 'Check for similar suggestions when posting:',
		'do_close_on_select' => 'Close suggestions with a selected response:',
		'do_complete_tags' => 'Show matching tags while typing:',
		'do_count_q_views' => 'Count the number of suggestion views:',
		'do_example_tags' => 'Show example tags based on suggestion:',
		'editor_for_as' => 'Default editor for responses:',
		'editor_for_cs' => 'Default editor for comments:',
		'editor_for_qs' => 'Default editor for suggestions:',
		...
		'extra_field_display_label' => 'Show the extra information on suggestion pages with label:',
		'extra_field_display' => 'Show the extra information on suggestion pages',
		'feed_for_activity' => 'Feed for recent activity:',
		'feed_for_hot' => 'Feed for hot suggestions:',
		'feed_for_qa' => 'Feed for recent suggestions and responses:',
		'feed_for_suggestions' => 'Feed for recent suggestions:',
		'feed_for_search' => 'Feeds for search results:',
		'feed_for_tag_qs' => 'Feed for each tag\'s suggestions:',
		'feed_for_unresponseed' => 'Feed for unresponseed suggestions:',
		...
		'follow_on_as' => 'Allow suggestions to be related to responses:',
		'from_email' => 'Sender address for messages from site:',
		'hot_weight_a_age' => 'Suggestion has a new response:',
		'hot_weight_responses' => 'Suggestion has many responses:',
		'hot_weight_q_age' => 'Suggestion is new:',
		'hot_weight_views' => 'Suggestion has many views:',
		'hot_weight_votes' => 'Suggestion has many up votes:',
		...
		'match_4' => 'Wider',
		'match_5' => 'Widest',
		'match_ask_check_qs' => 'Similar suggestions matching:',
		'match_example_tags' => 'Example tags matching:',
		'match_related_qs' => 'Related suggestions matching:',
		'max_len_q_title' => 'Maximum length of suggestion title:',
		'max_num_q_tags' => 'Maximum number of tags:',
		'max_rate_ip_as' => 'Rate limit for adding responses:',
		...
		'max_rate_ip_qs' => 'Rate limit for posting suggestions:',
		...
		'max_rate_user_as' => 'Maximum responses per user per hour:',
		...
		'max_rate_user_qs' => 'Maximum suggestions per user per hour:',
		'max_rate_user_uploads' => 'Maximum uploads per user per hour:',
		'max_rate_user_votes' => 'Maximum votes per user per hour:',
		'min_len_a_content' => 'Minimum length of response:',
		'min_len_c_content' => 'Minimum length of comment:',
		'min_len_q_content' => 'Minimum length of suggestion body:',
		'min_len_q_title' => 'Minimum length of suggestion title:',
		...
		'notify_admin_q_post' => 'Email this address when a suggestion is posted',
		'notify_users_default' => 'Check email notification box by default:',
		'option_default' => 'Default',
		'page_size_activity' => 'Length of All Activity page:',
		'page_size_ask_check_qs' => 'Maximum similar suggestions to show:',
		'page_size_ask_tags' => 'Maximum tag hints to show:',
		'page_size_home' => 'Length of Q&A page:',
		'page_size_hot_qs' => 'Length of Hot! page:',
		'page_size_q_as' => 'Maximum responses per page:',
		'page_size_qs' => 'Length of Suggestions page:',
		'page_size_related_qs' => 'Maximum related suggestions:',
		'page_size_search' => 'Search results per page:',
		'page_size_tag_qs' => 'Suggestions on each tag page:',
		'page_size_tags' => 'Length of Tags page:',
		'page_size_una_qs' => 'Length of Unresponseed page:',
		...
		'points_a_selected' => 'Having your response selected as the best:',
		'points_a_voted_max_gain' => 'Limit from up votes on each response:',
		'points_a_voted_max_loss' => 'Limit from down votes on each response:',
		'points_base' => 'Add for all users:',
		'points_multiple' => 'Multiply all points:',
		'points_per_a_voted_down' => 'Per down vote on your response:',
		'points_per_a_voted_up' => 'Per up vote on your response:',
		'points_per_q_voted_down' => 'Per down vote on your suggestion:',
		'points_per_q_voted_up' => 'Per up vote on your suggestion:',
		'points_post_a' => 'Posting an response:',
		'points_post_q' => 'Posting a suggestion:',
		'points_q_voted_max_gain' => 'Limit from up votes on each suggestion:',
		'points_q_voted_max_loss' => 'Limit from down votes on each suggestion:',
		'points_select_a' => 'Selecting an response for your suggestion:',
		'points_vote_down_a' => 'Voting down an response:',
		'points_vote_down_q' => 'Voting down a suggestion:',
		'points_vote_up_a' => 'Voting up an response:',
		'points_vote_up_q' => 'Voting up a suggestion:',
		'q_urls_remove_accents' => 'Remove accents from suggestion URLs:',
		'q_urls_title_length' => 'Suggestion title length in URLs:',
		'register_notify_admin' => 'Email me when a new user registers:',
		'search_module' => 'Use search module:',
		'show_a_form_immediate' => 'Show response form immediately:',
		'show_always' => 'Always',
		'show_c_reply_buttons' => 'Show reply button on comments:',
		'show_custom_response' => 'Custom message on response form - HTML allowed:',
		...
		'show_selected_first' => 'Move selected response to the top:',
		...
		'show_view_counts' => 'Show view count in suggestion lists:',
		'show_view_count_q_page' => 'Show view count on suggestion pages:',
